...
> = (props, ref) => {
  ...
  useEffect(() => {
    ...
    setCustomRenderers({
      ...
      block: DefaultDraftBlockRenderMap.merge(
        blockRenderMap,
  ...
  const handlePastedText = (
    ...
    const currentLength = editorState.getCurrentContent().getPlainText("")
      .length;
    return isGte(currentLength + text.length, props.maxLength)
      ? "handled"
      : "not-handled";
  };
  ...
  const inlineToolbarControls = props.inlineToolbarControls || [
    "bold",
    "italic",
    "underline",
    "clear",
